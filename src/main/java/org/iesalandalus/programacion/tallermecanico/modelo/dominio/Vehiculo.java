...
public record Vehiculo(String marca, String modelo, String matricula) {
    ...
    private static String ER_MARCA = "([A-ZÁÉÍÓÚ]+[a-záéíóú]*)[-]?[ ]?([A-ZÁÉÍÓÚ][a-záéíóú]+)?";
    private static String ER_MATRICULA = "[0-9]{4}[^\\W_AEIOUa-z]{3}";
    ...
    public static Vehiculo get(String matricula){
        return new Vehiculo("Rolls-Royce","2019", matricula);
    }
