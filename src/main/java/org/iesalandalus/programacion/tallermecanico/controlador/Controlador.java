    ...
    public void actualizar(Evento evento) {
        try {
            switch (evento){
                ...
                case MOSTRAR_ESTADISTICAS_MENSUALES -> { modelo.getEstadisticasMensuales(vista.leerMes()); vista.notificarResultado(Evento.MOSTRAR_ESTADISTICAS_MENSUALES, "Estadísticas mensuales mostradas correctamente",true);}
                case SALIR -> {}
            }
        } catch (Exception e){
